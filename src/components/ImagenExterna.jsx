...
const ImagenExterna = ({ nombreImagen, className = "", onClick, alt = "" }) => {
  ...
  useEffect(() => {
    ...
    async function obtenerImagen() {
      try {
        const url = `http://${servidor}:${puerto}/getImagen?imagen=${nombreImagen}&tipo=${tipo}`;
  ...
  return <img src={imagen} className={className} onClick={onClick} alt={alt} />;
};
